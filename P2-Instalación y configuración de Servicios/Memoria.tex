...
\begin{enumerate}
	...
	% En Ubuntu, usaremos \textbf{lamp-server^}
	% En CentOS, usaremos \textbf{httpct} para instalar Apache, \textbf{mariadb} para Maria-DB, \textbf{php} y \textbf{php-mysql} para PHP
