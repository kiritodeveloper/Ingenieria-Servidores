...
\begin{enumerate}
	...
	\subsection{Java Servlets}
		\item \textbf{Opcional:} Realice la instalación de uno de estos dos \textit{web containers} y
		pruebe su ejecución.
	...
	\subsection{Otro tipo de Bases de datos}
		\item \textbf{Opcional:} Realice la instalación de MongoDB en alguna de sus máquinas virtuales.
		Cree una colección de documentos y haga una consulta sobre ellos
	...
	\subsubsection*{Comandos grep, find, awk y sed}
		...
		\item \textbf{Opcional:} Muestre un ejemplo de uso para awk.
