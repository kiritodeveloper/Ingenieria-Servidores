...
\begin{enumerate}
	...
	\section{Instalación del servicio de acceso remoto a la consola(\textit{Secure Shell})}
		...
		\item En muchas ocasiones es necesario reiniciar un servicio para que tome los cambios en su
		configuración. Indique los comandos que puede emplear en Ubuntu y CentOS para hacerlo.
