...
\begin{enumerate}
	...
	\subsection{Conociendo el subsistema de archivos}
		\item 
		\begin{enumerate}
			\item ¿Qué archivo le permite ver qué programas se han instalado con el gestor de
			paquetes?
			
			\item ¿Qué significan las terminaciones .1.gz o .2.gz de los archivos en ese
			directorio?
		\end{enumerate}
